...
select TOP 10 b.Category_level2_name_eng, round(sum(a.sale_amount),2) as Sales, round((b.cost_price - a.sale_price),2) as Profit_Margin
from Transactions a
left join Product b
on a.product_id = b.PRODUCT_ID
group by b.Category_level2_name_eng, b.cost_price, a.sale_price
order by sum(a.sale_amount) desc
